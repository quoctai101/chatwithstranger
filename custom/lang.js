...
module.exports = {
	...
	FIRST_COME : '[Chatbot] Chào mừng bạn đến với chatbot. Trước khi bắt đầu, hãy chắc chắn rằng bạn đã chọn đúng giới tính. Ấn trợ giúp (hoặc gửi trogiup) để xem thêm.',
	...
	BATDAU_WARN_GENDER : "[Chatbot] Lưu ý: Bạn phải thiết lập giới tính trước khi chat.",
	...
	HELP_TXT : "[Chatbot] Danh sách các lệnh:\n" +
				...
				"- tim khac: Tìm bạn khác giới chat cùng",
